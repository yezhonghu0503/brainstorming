...
<template>
  <div class="button">
    ...
    <div class="text" data-text="登录">
      <el-row :gutter="20">
        <el-input input-style="{background: #d4d4d425;}" v-model="input1" class="w-50 m-2" placeholder="Type something">
          <template #prefix>
...
.button {
  ...
  cursor: pointer;
  background: #d4d4d425;
  -moz-box-shadow: 1px 0px 13px #170404;
  -webkit-box-shadow: 1px 0px 13px #170404;
  box-shadow: 1px 0px 13px #170404;
}
